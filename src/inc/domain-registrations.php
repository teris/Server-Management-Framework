    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                showNotification(response.error || '<?= t('error_loading_registration') ?>', 'error');
            }
        },
        error: function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                showNotification('<?= t('registration_updated_successfully') ?>', 'success');
            } else {
                showNotification(response.error || '<?= t('error_updating_registration') ?>', 'error');
            }
        },
        error: function() {
            showNotification('<?= t('network_error') ?>', 'error');
...
function approveRegistration(id) {
    showConfirmAction(
        ...
        '<?= t('confirm_approve_registration') ?>',
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                refreshRegistrations();
                showNotification(response.data.message || '<?= t('registration_status_updated') ?>', 'success');
            } else {
                showNotification(response.error || '<?= t('error_updating_status') ?>', 'error');
            }
        },
        error: function() {
            showNotification('<?= t('network_error') ?>', 'error');
