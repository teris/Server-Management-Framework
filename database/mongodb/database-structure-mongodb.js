// =============================================================================
// OPTIMIERTE MONGODB-STRUKTUR FÜR SERVER MANAGEMENT SYSTEM
// =============================================================================
// Erstellt: 2025-09-03
// Version: 2.0
// Beschreibung: MongoDB-Struktur basierend auf Systemanalyse
// =============================================================================
...
db.users.insertOne({
    username: "admin",
    email: "admin@mongodb-server.com",
...
db.modules.insertMany([
    ...
    { name: "proxmox", is_active: true },
    { name: "ispconfig", is_active: true },
    { name: "ovh", is_active: true },
    { name: "database", is_active: true },
    { name: "email", is_active: true },
    { name: "dns", is_active: true },
    { name: "network", is_active: true },
    { name: "support-tickets", is_active: true },
    { name: "virtual-mac", is_active: true },
    { name: "endpoints", is_active: true }
]);
...
db.system_settings.insertMany([
    {
        ...
        setting_value: "Server Management System (MongoDB)",
        setting_type: "string",
    ...
    },
    {
        ...
        setting_value: "https://mongodb-server.com",
        setting_type: "string",
    ...
    },
    {
        ...
        setting_value: "support@mongodb-server.com",
        setting_type: "string",
    ...
    },
    {
        ...
        setting_value: "system@mongodb-server.com",
        setting_type: "string",
    ...
    },
    {
        ...
        setting_value: "admin@mongodb-server.com",
        setting_type: "string",
...
db.settings.insertOne({
    site_title: "Server Management System (MongoDB)",
    logo_path: null,
    favicon_path: null,
    mode: "live"
});

print("MongoDB-Datenbankstruktur erfolgreich erstellt!");
print("Verwenden Sie 'mongo server_management < database-structure-mongodb.js' zum Ausführen.");
